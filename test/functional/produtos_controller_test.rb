...
class ProdutosControllerTest < ActionController::TestCase
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post :create, produto: { descricao: @produto.descricao, preco: @produto.preco, titulo: @produto.titulo, validade: @produto.validade }
    end
  ...
  test "should update produto" do
    put :update, id: @produto, produto: { descricao: @produto.descricao, preco: @produto.preco, titulo: @produto.titulo, validade: @produto.validade }
    assert_redirected_to produto_path(assigns(:produto))
  end
